...
#define kVENMO_AUTH_URL @"https://api.venmo.com/v1/oauth/authorize?client_id=1967&scope=make_payments%20access_profile%20access_balance&response_type=code&state="
